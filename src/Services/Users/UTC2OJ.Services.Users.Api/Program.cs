...
using UTC2OJ.ServiceDefaults.Extensions;
using UTC2OJ.Services.Customers;
using UTC2OJ.Services.Customers.Shared.Extensions.HostApplicationBuilderExtensions;
using UTC2OJ.Services.Customers.Shared.Extensions.WebApplicationExtensions;
using Microsoft.AspNetCore.HttpOverrides;
using Spectre.Console;

AnsiConsole.Write(
    new FigletText("Users Service").Centered().Color(Color.FromInt32(new Faker().Random.Int(1, 255)))
);
